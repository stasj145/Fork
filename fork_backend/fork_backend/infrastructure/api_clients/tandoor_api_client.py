...
class TandoorAPIClient:
    ...
    async def search_recipes(self, query: str, limit: int = 20) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            log.error("Request error occurred while searching recipes: %s", str(e))
            raise
        except Exception as e:
            log.error("Unexpected error occurred while searching recipes: %s", str(e))
            raise
    ...
    async def get_recipe_details(self, recipie_id: int) -> Dict[str, Any]:
        ...
        try:
            ...
            log.error("Unexpected error occurred while getting recipes: %s", str(e))
            raise
